...
| [a very short history of #datascience](https://www.forbes.com/sites/gilpress/2013/05/28/a-very-short-history-of-data-science/) | _The story of how data scientists became sexy is mostly the story of the coupling of the mature discipline of statistics with a very young one--computer science.  The term âData Scienceâ has emerged only recently to specifically designate a new profession that is expected to make sense of the vast stores of big data. But making sense of data has a long history and has been discussed by scientists, statisticians, librarians, computer scientists and others for years. The following timeline traces the evolution of the term âData Scienceâ and its use, attempts to define it, and related terms._ |
...
- [deprem-ml](https://huggingface.co/deprem-ml) [AYA: AÃ§Ä±k YazÄ±lÄ±m AÄÄ±](https://linktr.ee/acikyazilimagi) (+25k developers) is trying to help disaster response using artificial intelligence. Everything is open-sourced [afet.org](https://afet.org). 
...
| [envd](https://github.com/tensorchord/envd) | ðï¸ machine learning development environment for data science and AI/ML engineering teams |
| [Explore Data Science Libraries](https://kandi.openweaver.com/explore/data-science) | A search engine ð tool to discover & find a curated list of popular & new libraries, top authors, trending project kits, discussions, tutorials & learning resources |
| [MLEM](https://github.com/iterative/mlem) | ð¶ Version and deploy your ML models following GitOps principles |
...
| [Mert NuhoÄlu](https://twitter.com/mertnuhoglu)  | Data Scientist at BizQualify, Developer |
...
- [New Zealand Institute of Economic Research â Data1850](https://data1850.nz/)
...
- [Data Science and Machine Learning: Whatâs The Difference?](https://www.appliedaicourse.com/blog/data-science-and-machine-learning-whats-the-difference/)
